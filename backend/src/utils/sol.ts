...
// Platform Wallet - loaded from centralized config
const PLATFORM_WALLET = new PublicKey(CONFIG.PLATFORM_WALLET);

// Helius RPC for Devnet - TODO: move to env var for production
...
export async function sendSolPayout(
    ...
    try {
        ...
        // Send transaction WITHOUT waiting for confirmation (returns immediately)
        // The transaction will still be processed on the blockchain
