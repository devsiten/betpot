...
export async function verifyUSDCTransaction(
    ...
    try {
        // Connect to Solana devnet via Helius (more reliable)
        const connection = new Connection('https://devnet.helius-rpc.com/?api-key=e495db18-fb79-4c7b-9750-5bf08d316aaf', 'confirmed');
